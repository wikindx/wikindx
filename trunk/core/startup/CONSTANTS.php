...
define('WIKINDX_URL_COMPONENT', 'components');
define('WIKINDX_URL_COMPONENT_PLUGINS', implode('/', [WIKINDX_URL_COMPONENT, 'plugins']));
define('WIKINDX_URL_COMPONENT_STYLES', implode('/', [WIKINDX_URL_COMPONENT, 'styles']));
define('WIKINDX_URL_COMPONENT_TEMPLATES', implode('/', [WIKINDX_URL_COMPONENT, 'templates']));
define('WIKINDX_URL_COMPONENT_VENDOR', implode('/', [WIKINDX_URL_COMPONENT, 'vendor']));
...
define('WIKINDX_URL_DATA', 'data');
define('WIKINDX_URL_DATA_ATTACHMENTS', implode('/', [WIKINDX_URL_DATA, 'attachments']));
define('WIKINDX_URL_DATA_FILES', implode('/', [WIKINDX_URL_DATA, 'files']));
define('WIKINDX_URL_DATA_IMAGES', implode('/', [WIKINDX_URL_DATA, 'images']));
define('WIKINDX_URL_DATA_PLUGINS', implode('/', [WIKINDX_URL_DATA, 'plugins']));
...
define('WIKINDX_URL_CACHE', 'cache');
define('WIKINDX_URL_CACHE_ATTACHMENTS', implode('/', [WIKINDX_URL_CACHE, 'attachments']));
define('WIKINDX_URL_CACHE_FILES', implode('/', [WIKINDX_URL_CACHE, 'files']));
define('WIKINDX_URL_CACHE_LANGUAGES', implode('/', [WIKINDX_URL_CACHE, 'languages']));
define('WIKINDX_URL_CACHE_PLUGINS', implode('/', [WIKINDX_URL_CACHE, 'plugins']));
define('WIKINDX_URL_CACHE_STYLES', implode('/', [WIKINDX_URL_CACHE, 'styles']));
define('WIKINDX_URL_CACHE_TEMPLATES', implode('/', [WIKINDX_URL_CACHE, 'templates']));
