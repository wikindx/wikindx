...
/// hint_pagingInfoOf Follows hint_pagingInfo: '... of 345'
				...
				"siteMapAllow" => dgettext($domain, "This is only required if you wish to run a Sitemap. Sitemaps are essential for a good indexing of a website by search engines. WIKINDX indexes public resources and news in the sitemap. For details, see <a href='https://www.sitemaps.org/'>sitemaps.org</a>."),
				...
				"rssAllow" => dgettext($domain, "This is only required if you wish to run a RSS news feed for the latest additions to your WIKINDX. See README_RSS. If you do not check this, WIKINDX will block RSS access and will not display any RSS icon in the Firefox location bar. If checked, to allow RSS feed users to then click on the RSS link and access WIKINDX, you must also enable read only access"),
