...
UPDATE %%WIKINDX_DB_TABLEPREFIX%%users
SET usersUseBibtexKey = 'N'
WHERE usersUseBibtexKey IS NULL;

UPDATE %%WIKINDX_DB_TABLEPREFIX%%users
SET usersUseWikindxKey = 'N'
WHERE usersUseWikindxKey IS NULL;

UPDATE %%WIKINDX_DB_TABLEPREFIX%%users
SET usersDisplayBibtexLink = 'N'
WHERE usersDisplayBibtexLink IS NULL;

UPDATE %%WIKINDX_DB_TABLEPREFIX%%users
SET usersDisplayCmsLink = 'N'
...
ALTER TABLE %%WIKINDX_DB_TABLEPREFIX%%users MODIFY COLUMN usersUseBibtexKey varchar(1) COLLATE utf8mb4_unicode_520_ci NOT NULL DEFAULT 'N',
