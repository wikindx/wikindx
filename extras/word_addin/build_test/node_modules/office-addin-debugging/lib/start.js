 ...
 */
function startDebugging(manifestPath, appType, app, debuggingMethod = defaultDebuggingMethod(), sourceBundleUrlComponents, devServerCommandLine, devServerPort, packagerCommandLine, packagerHost, packagerPort, enableDebugging = true, enableLiveReload = true, openDevTools = false, document) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            try {
                ...
                yield office_addin_dev_settings_1.sideloadAddIn(manifestPath, app, true, appType, document, false /* isTest */);
            }
            catch (err) {
