...
/// importexport_ Messages relating to import/export of bibliographies and ideas
			"importexport" => array(
				...
				"menuimport" => dgettext($domain, "Import..."),
				...
				"menuExportHTML" => dgettext($domain, "HTML"),
				"menuExportEndNote" => dgettext($domain, "EndNote"),
				"menuExportRIS" => dgettext($domain, "RIS"),
				...
				"headerImportPubMed" => dgettext($domain, "Import PubMed"),
