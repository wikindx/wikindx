	...
	private function loadArrays()
	{
		...
		return array(
		    "success" => array(
				...
				"categoryAdd" => dgettext($domain, "Successfully added category"),
				"categoryEdit" => dgettext($domain, "Successfully edited category"),
				...
				"subcategoryAdd" => dgettext($domain, "Successfully added subcategory"),
				"subcategoryEdit" => dgettext($domain, "Successfully edited subcategory"),
				...
				"userAdd" => dgettext($domain, "Successfully added user"),
				"userEdit" => dgettext($domain, "Successfully edited user"),
				...
				"addBib" => dgettext($domain, "Successfully added item(s) to bibliography"),
				...
				"basketAdd" => dgettext($domain, "Successfully added resource(s) to basket"),
				"basketRemove" => dgettext($domain, "Successfully removed resource(s) from basket"),
