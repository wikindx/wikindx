 ...
 *
 * @see http://wikindx.sourceforge.net/ The WIKINDX SourceForge project
 *
...
class ADMINLANGUAGES
{
    ...
    public function init($message = FALSE)
    {
        ...
        if (!empty($languages))
        {
            ...
            { // thus missing name so get the original
            ...
            $td .= \FORM\selectedBoxValue(
                $this->messages->text("misc", "languageEdit"),
                'languageId',
                $fields,
                $id,
                10,
            ...
            $td .= \FORM\selectFBoxValueMultiple(
                $this->messages->text("misc", "languageDelete"),
                'languageIds',
                $languages,
                10
        ...
        \AJAX\loadJavascript([WIKINDX_URL_BASE . '/' . 'core/modules/admin/languageEdit.js']);
