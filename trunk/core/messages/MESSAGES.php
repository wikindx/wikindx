...
/// hint_pagingInfoOf Follows hint_pagingInfo: '... of 345'
				...
				"rssAllow" => dgettext($domain, "This is only required if you wish to run a RSS news feed for the latest additions to your WIKINDX. See README_RSS. If you do not check this, WIKINDX will block RSS access. If checked, to allow RSS feed users to then click on the RSS link and access WIKINDX, you must also enable read only access"),
