...
$script .= '<script src="' . WIKINDX_BASE_URL . '/' . WIKINDX_URL_COMPONENT_PLUGINS . '/wordprocessor/' . basename(__DIR__) . '/js/wikindxWPFootnotedialog.js?ver=' . WIKINDX_PUBLIC_VERSION . '"></script>';
